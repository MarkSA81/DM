...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_CUTE_CHARM, ABILITY_MAGICIAN },
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_PANCHAM] =
    {
        ...
        .abilities = { ABILITY_IRON_FIST, ABILITY_KEEN_EYE, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_PANGORO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_IRON_FIST, ABILITY_INTIMIDATE, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_WHITE,
