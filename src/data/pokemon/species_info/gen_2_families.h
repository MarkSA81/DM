...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_SHADOW_SHIELD, ABILITY_FLASH_FIRE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .abilities = { ABILITY_ILLUMINATE, ABILITY_ADAPTABILITY, ABILITY_VOLT_ABSORB },
        .bodyColor = BODY_COLOR_BLUE,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_HONCHKROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SUPREME_OVELORD, ABILITY_SUPER_LUCK, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BLACK,
